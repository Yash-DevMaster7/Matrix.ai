          ...
          <div className="w-11/12 h-1/2 flex flex-col justify-around items-center">
            <div className="w-4/5">
              <textarea
                id="message"
                rows={8}
                className="block p-2.5 w-full h-20 md:h-44 mt-2 md:mt-0 text-sm rounded-lg border focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white"
